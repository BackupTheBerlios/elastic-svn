...
void print_pos(const char *st_line, const char *st_cptr)
{
...
void syntax_error(int st_lineno, const char *st_line, const char *st_cptr)
{
...
void unterminated_comment(int c_lineno, const char *c_line, const char *c_cptr)
{
...
void unterminated_string(int s_lineno, const char *s_line, const char *s_cptr)
{
...
void unterminated_text(int t_lineno, const char *t_line, const char *t_cptr)
{
...
void unterminated_union(int u_lineno, const char *u_line, const char *u_cptr)
{
	fprintf(stderr,
...
void over_unionized(const char *u_cptr)
{
	fprintf(stderr,
...
void illegal_tag(int t_lineno, const char *t_line, const char *t_cptr)
{
	fprintf(stderr,
...
void illegal_character(const char *c_cptr)
{
	fprintf(stderr,
...
void dollar_error(int a_lineno, const char *a_line, const char *a_cptr)
{
	fprintf(stderr,
...
void undefined_symbol_warning(const char *s, int l)
{
	fprintf(stderr,
			"%s: w - the symbol %s is undefined (line %d)\n",
			myname, s, l);
}
